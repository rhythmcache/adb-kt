...
class AdbSideload(private val connection: AdbConnection) {
    ...
    fun sideload(file: File, blockSize: Int = DEFAULT_BLOCK_SIZE): Flow<SideloadProgress> =
        sideload(RandomAccessSource.of(file), blockSize)
     ...
     */
    fun sideload(source: RandomAccessSource, blockSize: Int = DEFAULT_BLOCK_SIZE): Flow<SideloadProgress> = flow {
